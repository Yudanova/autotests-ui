...
class CreateCoursePage(BasePage):
    def __init__(self, page: Page):
        ...
        # Preview and area with image of preview the course
        ...
        # The modal of creating the course
        ...
        self.create_course_description_textarea = (
            # When searching description field 2 tags of textarea will be found: take the first one (check by typing)
        ...
        # Title and create exercises button
    ...
    def upload_preview_image(self, file: str):
        ...
        with self.page.expect_file_chooser() as fc_info:
            self.preview_image_upload_button.click()
        fc = fc_info.value
