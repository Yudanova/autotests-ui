...
class DashboardPage(BasePage):
    def __init__(self, page: Page):
        ...
        self.students.title = page.get_by_test_id('students-widget-title-text')
        self.students.chart = page.get_by_test_id('students-bar-chart')

        self.activities.title = page.get_by_test_id('activities-widget-title-text')
        self.activities.chart = page.get_by_test_id('activities-line-chart')

        self.courses.title = page.get_by_test_id('courses-widget-title-text')
        self.courses.chart = page.get_by_test_id('courses-pie-chart')

        self.scores.title = page.get_by_test_id('scores-widget-title-text')
        self.scores.chart = page.get_by_test_id('scores-scatter-chart')
